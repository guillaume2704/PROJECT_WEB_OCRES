...
export default class Api {
    ...
    createProfile(publication) {
        ...
        return axios.post("http://localhost:3003/users", publication, { crossdomain: true })
    }

    updateProfile(profile) {
        return axios.put(`http://localhost:3003/users/${profile.id}`, profile, { crossdomain: true })
    }
}